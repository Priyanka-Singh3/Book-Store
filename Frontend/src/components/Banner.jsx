        ...
        <div className="w-full md:w-1/2 order-2 md:order-1">
          <div className="space-y-12 mt-12 md:mt-32">
            <h1 className="text-2xl md:text-4xl font-bold ">
              ...
              <span className="text-pink-500"> book store Application !!</span>
            </h1>
            <p className="md:text-xl">
              Lorem ipsum, dolor sit amet consectetur adipisicing elit. Eveniet
              obcaecati sunt ea voluptatibus quidem vero odit minima voluptatem
              nisi maxime.
            </p>
          ...
          <button className="btn btn-secondary bg-pink-400 mt-12">Secondary</button>
        </div>
